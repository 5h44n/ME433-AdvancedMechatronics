...
void APP_Initialize(void) {
    ...
    TRISAbits.TRISA4 = 0;                                        
    LATAbits.LATA4 = 0;                                     // set up green LED heartbeat check
    ...
    OC1RS = 0; // duty cycle //UPDATE THESE VALUES TO UPDATE DUTY CYCLE
    OC1R = 0; // initialize before turning OC1 on; afterward it is read-only
    OC4CONbits.OCM = 0b110; // PWM mode without fault pin; other OCxCON bits are defaults
    OC4RS = 0; // duty cycle //UPDATE THESE VALUES TO UPDATE DUTY CYCLE
    ...
    //  set Timer4 to fixed time control interrupt
